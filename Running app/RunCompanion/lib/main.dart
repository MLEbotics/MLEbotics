...
class _RobotControlPageState extends State<RobotControlPage> {
  ...
  String _hybridStatus(HybridSyncState state) {
    ...
    final version =
        state.manifestVersion != null ? 'v${state.manifestVersion}' : 'n/a';
                          ...
                          return ListView.separated(
                            ...
                            itemBuilder: (_, i) {
                              ...
                              return Dismissible(
                                ...
                                onDismissed:
                                    (_) => _firestoreService.deleteRunSession(
                                      doc.id,
                                    ),
                                child: ListTile(
                                  ...
                                  trailing: IconButton(
                                    ...
                                    onPressed: () async {
                                      final ok =
                                          ...
                                          false;
                                      if (ok) {
                                        _firestoreService.deleteRunSession(
                                          doc.id,
                                        );
                                      }
                                    },
    ...
    return Scaffold(
                ...
                children: [
                  ...
                  Text(
                    ...
                    style: TextStyle(
                      ...
                      fontWeight: FontWeight.bold,
                      color:
                          _isConnected ? Colors.tealAccent : Colors.redAccent,
                    ),
                  ),
                ],
              ),
      ...
      body: Stack(
        children: [
          ...
          SafeArea(
            child: Padding(
              padding: const EdgeInsets.only(top: kToolbarHeight + 6),
              child: Column(
                children: [
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        gradient: LinearGradient(
          colors:
              _isConnected
                  ? [const Color(0xFF0C5546), const Color(0xFF0A6A5F)]
                  : [const Color(0xFF25333D), const Color(0xFF3D4C59)],
      ...
      child: Row(
        children: [
          ...
          ValueListenableBuilder<HybridSyncState>(
            ...
            builder:
                (context, state, _) => GestureDetector(
